...
from .views import schedule_evaluation, create_evaluation, view_evaluations, view_scheduled_evaluations, evaluation_detail, get_questions, export_evaluation, export_all_evaluations, analysis, delete_schedule, edit_schedule
urlpatterns = [
